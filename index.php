...
if(file_exists($file)){
	...
	include "front/main.php";
				...
				?>
					...
					?>
					<button style="width:100%; margin-left:auto; margin-right:auto; margin-top:2px; height:50px;" onclick="lo(&#39;back.phpf&#39;)">返回管理</button>
					<?php }else{ ?>
			...
			<div class="t" onclick="pp(1)"><img src="icon/up.jpg" alt=""></div>
			<?php
$imgs=$Image->all(['sh'=>1]);
foreach($imgs as $k => $v){
			?>
			<div class="im cent" id="ssaa<?=$k;?>">
<img src="img/<?=$v['img']?>" style="width:150px;height:103px">
			</div>
			<?php
			}?>
